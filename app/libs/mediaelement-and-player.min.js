...
mejs.Utility = {
	...
	getScriptPath: function(a) {
		...
		c, d = "",
		e = "",
		g, f, i = document.getElementsByTagName("script"), k = i.length, h = a.length; b < k; b++) {
			g = i[b].src;
			c = g.lastIndexOf("/");
			if (c > -1) {
				f = g.substring(c + 1);
...
window.mejs = mejs;
window.MediaElement = mejs.MediaElement; (function(a, b) {
	var c = {
		locale: {
			language: "",
			strings: {}
...
if (typeof jQuery != "undefined") mejs.$ = jQuery;
	...
	mejs.MediaElementPlayer.prototype = {
		...
		buildposter: function(a, b, c, e) {
			...
			false);
			a.options.showPosterWhenEnded && a.options.autoRewind && e.addEventListener("ended",
			function() {
				d.show()
			},
			false)
		...
		buildoverlays: function(a, b, c, e) {
			...
			if (a.isVideo) {
				...
				j = f('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>').appendTo(c).bind("click touchstart",
				function() {
		...
		buildkeyboard: function(a, b, c, e) {
			...
			function(d) {
				if (a.hasFocus && a.options.enableKeyboard) for (var g = 0,
				k = a.options.keyActions.length; g < k; g++) for (var j = a.options.keyActions[g], m = 0, q = j.keys.length; m < q; m++) if (d.keyCode == j.keys[m]) {
					d.preventDefault();
	...
	f.extend(MediaElementPlayer.prototype, {
		...
		buildtracks: function(a, b, c, e) {
			if (a.tracks.length != 0) {
				...
				this.options.toggleCaptionsButtonWhenOnlyOne && b == 1 ? a.captionsButton.on("click",
				function() {
				...
				function() {
					a.hasChapters && !e.paused && a.chapters.fadeOut(200,
					function() {
		...
		showSlide: function(a) {
			if (! (typeof this.tracks == "undefined" || typeof this.slidesContainer == "undefined")) {
				...
				if (typeof e == "undefined" || typeof e.fadeIn == "undefined") b.slides.entries.imgs[a] = e = f('<img src="' + c + '">').on("load",
				function() {
	...
	f.extend(MediaElementPlayer.prototype, {
		...
		renderContextMenu: function(a, b) {
			...
			g = 0,
			k = d.length; g < k; g++) if (d[g].isSeparator) e += '<div class="mejs-contextmenu-separator"></div>';
			else {
				var j = d[g].render(c);
